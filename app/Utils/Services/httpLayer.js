...
const get = async (endpoint, showLoaderFlag = true) => {
    let url = Environments['url']+ endpoint;
  ...
  const post = async (endpoint, params, showLoaderFlag = true, cancelToken = undefined) => {
